	...
	function (msg, model) {
		switch (msg.$) {
			case 'OpenNavBar':
				return _Utils_update(
					model,
					{isNavBarToggledOpen: true});
			case 'CloseNavBar':
				return _Utils_update(
					model,
					{isGuestsMenuOpen: false, isLocationMenuOpen: false, isNavBarToggledOpen: false, newAdultsAmount: model.guests.adults, newChildrenAmount: model.guests.children, newLocation: model.location});
			case 'LocationChange':
				var newLocation = msg.a;
				return _Utils_update(
					model,
					{newLocation: newLocation});
			case 'OpenLocationFilterMenu':
				return _Utils_update(
					model,
					{isLocationMenuOpen: true});
			case 'CloseLocationFilterMenu':
				return _Utils_update(
					model,
					{isLocationMenuOpen: false});
			case 'OpenGuestsFilterMenu':
				return _Utils_update(
					model,
					{isGuestsMenuOpen: true});
			case 'CloseGuestsFilterMenu':
				return _Utils_update(
					model,
					{isGuestsMenuOpen: false});
			case 'RemoveAdult':
				return _Utils_update(
					model,
					{
						newAdultsAmount: ((model.newAdultsAmount - 1) < 0) ? 0 : (model.newAdultsAmount - 1)
					});
			case 'AddAdult':
				return _Utils_update(
					model,
			...
			case 'RemoveChild':
				return _Utils_update(
					model,
					{
						newChildrenAmount: ((model.newChildrenAmount - 1) < 0) ? 0 : (model.newChildrenAmount - 1)
					});
			case 'AddChild':
				return _Utils_update(
					model,
...
var $author$project$Data$data = _List_fromArray(
	[
		{
		beds: $elm$core$Maybe$Just(2),
		city: 'Helsinki',
		country: 'Finland',
		maxGuests: 3,
		...
		{beds: $elm$core$Maybe$Nothing, city: 'Helsinki', country: 'Finland', maxGuests: 3, photo: 'https://images.unsplash.com/photo-1556020685-ae41abfc9365?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=934&q=80', rating: 4.48, superHost: false, title: 'Apartment next to market spuare', type_: 'Entire apartment'},
		{beds: $elm$core$Maybe$Nothing, city: 'Turku', country: 'Finland', maxGuests: 9, photo: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2249&q=80', rating: 4.75, superHost: true, title: 'Villa Aurora guest-house', type_: 'Entire house'},
		{beds: $elm$core$Maybe$Nothing, city: 'Vaasa', country: 'Finland', maxGuests: 6, photo: 'https://images.unsplash.com/photo-1524758631624-e2822e304c36?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2250&q=80', rating: 4.95, superHost: true, title: 'A cosy family house', type_: 'Entire house'},
		{beds: $elm$core$Maybe$Nothing, city: 'Vaasa', country: 'Finland', maxGuests: 2, photo: 'https://images.unsplash.com/photo-1505693314120-0d443867891c?ixlib=rb-1.2.1&auto=format&fit=crop&w=2591&q=80', rating: 4.68, superHost: false, title: 'Lovely Studio near Railway Station', type_: 'Private room'},
		{
		beds: $elm$core$Maybe$Just(3),
		city: 'Oulu',
		country: 'Finland',
		...
		{beds: $elm$core$Maybe$Nothing, city: 'Oulu', country: 'Finland', maxGuests: 4, photo: 'https://images.unsplash.com/photo-1522156373667-4c7234bbd804?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjF9&auto=format&fit=crop&w=930&q=80', rating: 4.38, superHost: true, title: 'Cozy woodhouse flat with wooden sauna', type_: 'Entire house'},
		{
		beds: $elm$core$Maybe$Just(3),
		city: 'Vaasa',
		country: 'Finland',
		...
		{beds: $elm$core$Maybe$Nothing, city: 'Helsinki', country: 'Finland', maxGuests: 10, photo: 'https://images.unsplash.com/photo-1516455590571-18256e5bb9ff?ixlib=rb-1.2.1&auto=format&fit=crop&w=2250&q=80', rating: 4.63, superHost: false, title: 'Beautiful and comfortable old wooden house', type_: 'Entire house'},
		{
		beds: $elm$core$Maybe$Just(3),
		city: 'Turku',
		country: 'Finland',
...
var $author$project$Main$filterRooms = F2(
	function (roomsData, model) {
		var totalGuests = model.guests.adults + model.guests.children;
		return A2(
			$elm$core$List$filter,
			function (l) {
				return _Utils_cmp(l.maxGuests, totalGuests) > -1;
			},
			A2(
				$elm$core$List$filter,
				function (l) {
					return _Utils_eq(l.city + (', ' + l.country), model.location);
				},
				roomsData));
	});
...
var $author$project$Main$roomCard = function (roomData) {
	var beds = $elm$core$String$fromInt(
		A2($elm$core$Maybe$withDefault, 0, roomData.beds));
	var roomType = (beds !== '0') ? (roomData.type_ + ('. ' + (beds + ' beds'))) : roomData.type_;
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('room-card')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src(roomData.photo),
						$elm$html$Html$Attributes$class('room-card__image')
					]),
				_List_Nil),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('room-card-info')
					]),
				_List_fromArray(
					[
						A2(
						$author$project$Main$iff,
						roomData.superHost,
						A2(
							$elm$html$Html$div,
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('room-card-info__super-host')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Super Host')
								]))),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('room-card-info__details')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('room-card-info__type faint-text')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(roomType)
									])),
								A2(
								$elm$html$Html$p,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('room-card-info__rating')
									]),
								_List_fromArray(
									[
										A2(
										...
										$elm$html$Html$text(
										$elm$core$String$fromFloat(roomData.rating))
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('room-card__title')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(roomData.title)
					]))
			]));
};
var $author$project$Main$cardsGrid = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('room-cards-grid-list')
					]),
				A2(
					$elm$core$List$map,
					function (l) {
						return A2(
							...
							_List_fromArray(
								[
									$author$project$Main$roomCard(l)
								]));
					},
					A2($author$project$Main$filterRooms, $author$project$Data$data, model)))
			]));
};
var $elm$html$Html$h2 = _VirtualDom_node('h2');
var $elm$html$Html$header = _VirtualDom_node('header');
var $elm$html$Html$main_ = _VirtualDom_node('main');
var $author$project$Main$CloseNavBar = {$: 'CloseNavBar'};
var $author$project$Main$SetNewFilter = {$: 'SetNewFilter'};
var $author$project$Main$AddAdult = {$: 'AddAdult'};
var $author$project$Main$AddChild = {$: 'AddChild'};
var $author$project$Main$CloseGuestsFilterMenu = {$: 'CloseGuestsFilterMenu'};
var $author$project$Main$OpenGuestsFilterMenu = {$: 'OpenGuestsFilterMenu'};
var $author$project$Main$RemoveAdult = {$: 'RemoveAdult'};
var $author$project$Main$RemoveChild = {$: 'RemoveChild'};
...
var $author$project$Main$guestsFilterContainerView = function (model) {
	var totalGuests = model.newAdultsAmount + model.newChildrenAmount;
	return model.isGuestsMenuOpen ? A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('filter-container')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('filter-title'),
						$elm$html$Html$Events$onClick($author$project$Main$CloseGuestsFilterMenu)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('between align-center')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												(totalGuests > 0) ? $elm$core$String$fromInt(totalGuests) : 'Add guests')
											]))
									])),
								A2(
								$elm$html$Html$span,
								...
								_List_fromArray(
									[
										$elm$html$Html$text('expand_less')
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('filter-container-content')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('guests-sub-title')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Adults')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('faint-text')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Ages 13 or above')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('guests-action-buttons')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$RemoveAdult),
										$elm$html$Html$Attributes$disabled(!model.newAdultsAmount)
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$elm$core$String$fromInt(model.newAdultsAmount))
									])),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$AddAdult)
									]),
								_List_fromArray(
									[
										A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$RemoveChild),
										$elm$html$Html$Attributes$disabled(!model.newChildrenAmount)
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$elm$core$String$fromInt(model.newChildrenAmount))
									])),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$AddChild)
									]),
								_List_fromArray(
									[
										A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('filter-container filter-title'),
				$elm$html$Html$Events$onClick($author$project$Main$OpenGuestsFilterMenu)
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Main$CloseLocationFilterMenu = {$: 'CloseLocationFilterMenu'};
var $author$project$Main$LocationChange = function (a) {
	return {$: 'LocationChange', a: a};
};
var $author$project$Main$OpenLocationFilterMenu = {$: 'OpenLocationFilterMenu'};
var $author$project$Main$filterOutLocation = F2(
...
var $author$project$Main$getLocations = function (items) {
...
var $author$project$Main$locationView = function (place) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('location__left-content')
					]),
				_List_fromArray(
					[
						A2(
...
var $author$project$Main$locationFilterContainerView = function (model) {
	return model.isLocationMenuOpen ? A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('filter-container')
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('filter-title'),
						$elm$html$Html$Events$onClick($author$project$Main$CloseLocationFilterMenu)
					]),
				_List_fromArray(
					[
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(model.newLocation)
											]))
									])),
								A2(
								$elm$html$Html$span,
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('filter-conter__content')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('location-list')
									]),
								A2(
									$elm$core$List$map,
									function (l) {
										return A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('location-list__item'),
													$elm$html$Html$Events$onClick(
													$author$project$Main$LocationChange(l))
												]),
											_List_fromArray(
												[
													$author$project$Main$locationView(l)
												]));
									},
									A2(
										$author$project$Main$filterOutLocation,
										$elm$core$Set$toList(
											$author$project$Main$getLocations($author$project$Data$data)),
										model.location)))
							]))
					]))
			])) : A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('filter-container filter-title'),
				$elm$html$Html$Events$onClick($author$project$Main$OpenLocationFilterMenu)
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Main$expandedNavBar = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('navbar navbar__open')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('navbar-top')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Edit your search')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('close-navbar-icon')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('material-icons'),
										$elm$html$Html$Events$onClick($author$project$Main$CloseNavBar)
									]),
								_List_fromArray(
									[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('filters-container')
					]),
				_List_fromArray(
					[
						$author$project$Main$locationFilterContainerView(model),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('divider-horizontal')
							]),
						_List_Nil),
						$author$project$Main$guestsFilterContainerView(model),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('search-button'),
								$elm$html$Html$Events$onClick($author$project$Main$SetNewFilter)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('material-icons primary-color')
									]),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('close-navbar-icon-desktop')
							]),
						_List_fromArray(
							[
								A2(
...
var $author$project$LogoSvg$logo = A2(
	$elm$svg$Svg$svg,
	_List_fromArray(
		[
			...
			$elm$svg$Svg$Attributes$viewBox('0 0 96 19'),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$d('M8.22724 4.5C9.38194 2.5 12.2687 2.5 13.4234 4.5L19.0526 14.25C20.2073 16.25 18.7639 18.75 16.4545 18.75H5.19615C2.88675 18.75 1.44338 16.25 2.59808 14.25L8.22724 4.5Z'),
					$elm$svg$Svg$Attributes$fill('#EB5757')
				]),
			_List_Nil)
		]));
var $elm$html$Html$nav = _VirtualDom_node('nav');
var $author$project$Main$OpenNavBar = {$: 'OpenNavBar'};
var $author$project$Main$smallNavActions = function (model) {
	var thereAreGuests = (model.guests.adults + model.guests.children) > 0;
	var textClass = thereAreGuests ? '' : 'faint-text';
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('smallNavActions'),
				$elm$html$Html$Events$onClick($author$project$Main$OpenNavBar)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(model.location)
					])),
				A2(
				$elm$html$Html$p,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('boxed ' + textClass)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
						thereAreGuests ? ($elm$core$String$fromInt(model.guests.adults + model.guests.children) + ' Guests') : 'Add guests')
					])),
				A2(
				$elm$html$Html$span,
				_List_fromArray(
...
var $author$project$Main$navBar = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('navbar navbar__closed')
			]),
		_List_fromArray(
			[
				$author$project$LogoSvg$logo,
				$author$project$Main$smallNavActions(model),
				A2(
				$author$project$Main$iff,
				model.isNavBarToggledOpen,
				$author$project$Main$expandedNavBar(model))
			]));
};
var $author$project$Main$view = function (model) {
	var numberOfStays = $elm$core$List$length(
		A2($author$project$Main$filterRooms, $author$project$Data$data, model));
	return A2(
		$elm$html$Html$main_,
		_List_fromArray(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('row between stays-title')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Stays in Finland')
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								...
								numberOfStays > 0,
								$elm$html$Html$text(
									$elm$core$String$fromInt(numberOfStays) + '+ stays'))
							]))
					])),
				$author$project$Main$cardsGrid(model)
			]));
};
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Main$init, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"OpenNavBar":[],"CloseNavBar":[],"LocationChange":["String.String"],"OpenLocationFilterMenu":[],"CloseLocationFilterMenu":[],"OpenGuestsFilterMenu":[],"CloseGuestsFilterMenu":[],"AddAdult":[],"RemoveAdult":[],"AddChild":[],"RemoveChild":[],"SetNewFilter":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
...
},{"./src/Main.elm":"src/Main.elm"}],"C:/Users/JOHNMG/AppData/Roaming/nvm/v12.13.1/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/JOHNMG/AppData/Roaming/nvm/v12.13.1/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
